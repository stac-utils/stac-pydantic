...
class ClassObject(BaseModel):
    """
    https://github.com/radiantearth/stac-spec/tree/v1.0.0-beta1/extensions/label#class-object
    """
...
class CountObject(BaseModel):
    """
    https://github.com/radiantearth/stac-spec/tree/v1.0.0-beta1/extensions/label#count-object
    """
...
class StatsObject(BaseModel):
    """
    https://github.com/radiantearth/stac-spec/tree/v1.0.0-beta1/extensions/label#stats-object
    """
...
class OverviewObject(BaseModel):
    """
    https://github.com/radiantearth/stac-spec/tree/v1.0.0-beta1/extensions/label#label-overview-object
    """
...
class LabelExtension(BaseModel):
    """
    https://github.com/radiantearth/stac-spec/tree/v1.0.0-beta1/extensions/label#label-extension-specification
    """
