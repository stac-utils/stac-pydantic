...
class ClassObject(BaseModel):
    """
    https://github.com/stac-extensions/label#class-object
    """
...
class CountObject(BaseModel):
    """
    https://github.com/stac-extensions/label#count-object
    """
...
class StatsObject(BaseModel):
    """
    https://github.com/stac-extensions/label#stats-object
    """
...
class OverviewObject(BaseModel):
    """
    https://github.com/stac-extensions/label#label-overview-object
    """
