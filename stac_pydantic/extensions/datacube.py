...
class HorizontalSpatialDimension(DimensionObject):
    """
    https://github.com/stac-extensions/datacube#horizontal-spatial-dimension-object
    """
...
class VerticalSpatialDimension(HorizontalSpatialDimension):
    """
    https://github.com/stac-extensions/datacube#vertical-spatial-dimension-object
    """
