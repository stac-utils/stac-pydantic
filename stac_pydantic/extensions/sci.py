...
class PublicationObject(BaseModel):
    """
    https://github.com/radiantearth/stac-spec/tree/v1.0.0-beta1/extensions/scientific#publication-object
    """
...
class ScientificExtension(PublicationObject):
    """
    https://github.com/radiantearth/stac-spec/tree/v1.0.0-beta1/extensions/scientific#item-and-collection-fields
    """
